...
from backend.agents.auto_commander import build_pipeline, MCP_URL
from backend.core.grid_world import GridWorld
from backend.services import met_feed, handoff_log
...
class AgentRunner:
    ...
    async def run_cycle(self) -> None:
        ...
        try:
            ...
            # Firestore audit-trail removed for v3 (credentials + timeout risk).
